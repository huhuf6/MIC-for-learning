...
module {
  util.func public @case_truncate(%arg0: tensor<4x4xf32>, %arg1: tensor<4x4xf16>, %arg2: tensor<4x4xf16>, %arg3: tensor<4x4xf16>) -> tensor<4x4xf16> {
    ...
    %1 = linalg.generic {indexing_maps = [#map, #map], iterator_types = ["parallel", "parallel"]} ins(%arg0 : tensor<4x4xf32>) outs(%0 : tensor<4x4xf16>) {
    ^bb0(%in: f32, %out: f16):
      %4 = arith.truncf %in : f32 to f16
      linalg.yield %4 : f16
    } -> tensor<4x4xf16>
    %2 = tensor.empty() : tensor<4x4xf16>
    %3 = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel"]} ins(%1, %arg1 : tensor<4x4xf16>, tensor<4x4xf16>) outs(%2 : tensor<4x4xf16>) {
    ^bb0(%in: f16, %in_0: f16, %out: f16):
      %4 = arith.addf %in, %in_0 : f16
      linalg.yield %4 : f16
    } -> tensor<4x4xf16>
    util.return %3 : tensor<4x4xf16>
  }
}
